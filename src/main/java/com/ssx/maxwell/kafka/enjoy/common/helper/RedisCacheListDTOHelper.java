...
public class RedisCacheListDTOHelper {
     ...
     * @return
     */
    public RedisCacheListDTO customRedisCacheLoadAndGet(RedisMappingDO redisMapping, String dbDatabase, String dbTable, String dbPid) {
        //自定义缓存
        String jdbcSql = MessageFormat.format(MaxwellBinlogConstants.RedisRunSqlTemplateEnum.SQL_PRIMARY_ID.getTemplate(), dbTable, dbPid);
        ...
        log.info("sql= {} , key= {}", jdbcSql, redisKey);
        return executeToRedis(beanHelper.loopGetDynamicDsInfo(dbDatabase), jdbcSql, redisKey, redisMapping, true, Long.MAX_VALUE);
    }
